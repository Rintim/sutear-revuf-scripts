...
var App = class extends Component {
  ...
  async componentDidMount() {
    ...
    let fallbackCount = /* @__PURE__ */ new Map();
...
var App2 = class extends Component2 {
  ...
  render(_props, state) {
    return /* @__PURE__ */ h2(Fragment2, null, /* @__PURE__ */ h2("p", null, "Percent: ", Math.floor(state.percent * 100) / 100, "%"), /* @__PURE__ */ h2("p", null, "Current File: ", state.currentFile));
  }
};
